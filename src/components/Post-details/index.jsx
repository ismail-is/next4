                    ...
                    <div className="col-lg-10">
                      <div className="cont">
                        <div className="spacial">
                          <p>
                          Rohan Hospitality Suites offers a luxurious retreat for discerning travelers seeking comfort and convenience. Located in the heart of the city, our suites boast elegant interiors and modern amenities, providing a seamless blend of style and functionality. Whether for business or leisure, guests enjoy personalized service and a host of facilities, including well-appointed rooms, gourmet dining options, and state-of-the-art meeting spaces. With a commitment to excellence, Rohan Hospitality
                          </p>
                        </div>
